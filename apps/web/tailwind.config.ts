  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        drawerIn: { from: { opacity: "0", transform: "translateX(40px)" }, to: { opacity: "1", transform: "none" } },
        toastIn: { from: { opacity: "0", transform: "translateX(120%) scale(.96)" }, to: { opacity: "1", transform: "none" } },
        toastBar: { from: { transform: "scaleX(1)" }, to: { transform: "scaleX(0)" } },
      },
      animation: {
        ...
        "drawer-in": "drawerIn .38s cubic-bezier(.2,.9,.25,1) both",
        "toast-in": "toastIn .4s cubic-bezier(.2,.9,.25,1) both",
        "toast-bar": "toastBar 5s linear both",
      },
    },
  },
  plugins: [],
