...
`openapi.yaml` is the versioned OpenAPI 3.1 contract for Testra's documented REST API. It currently covers auth, organizations, workspaces, and projects, including the project routes recorded as implemented in the Phase 0 progress report.
