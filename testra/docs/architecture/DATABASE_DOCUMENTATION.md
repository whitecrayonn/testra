...
Current progress records users, organizations, workspaces, and projects as migrated/implemented. Planned Phase 1 entities include roles, permissions, role assignments, and API keys. Later phases add test management, runs/results, defects, notifications, analytics, and integrations.

The authoritative relationship view is `docs/architecture/ERD.md`; it distinguishes current from planned entities.
